(function () {
	...
	function Element(tagName, props, children) {
	  if (!(this instanceof Element)) {
	    if (!_$2.isArray(children) && children != null) {
	      children = _$2.slice(arguments, 2).filter(_$2.truthy);
	    }

	    return new Element(tagName, props, children);
	  }

	  if (_$2.isArray(props)) {
	    children = props;
	    props = {};
	  }
	  ...
	  _$2.each(this.children, function (child, i) {
	...
	Element.prototype.render = function () {
	  ...
	  for (var propName in props) {
	    ...
	    _$2.setAttr(el, propName, propValue);
	  }

	  _$2.each(this.children, function (child) {
	...
	var patch$2 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.assign(/*#__PURE__*/Object.create(null), patch_1, {
		'default': patch_1
	}));

	var require$$1 = /*@__PURE__*/getAugmentedNamespace(patch$2);
